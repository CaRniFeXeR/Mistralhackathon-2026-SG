...
const GameInstructions: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            {/* Navigation */}
            <nav className="w-full flex justify-end mb-2">
                <button
                    onClick={() => navigate('/role-selection')}
                    className="text-white hover:text-gray-400 flex items-center font-bold"
                >
                    NEXT
                    <svg className="h-8 w-8 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Footer */}
            <footer className="text-center mt-4 flex flex-col items-center">
